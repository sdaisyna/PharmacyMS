    ...
    <div class="modal-content">
      ...
      {{ csrf_field() }}
          ...
          <div class="input-group mb-4">
              ...
              <input id="email" type="text" class="form-control col-12{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Email address" value="{{ old('email') }}" required autofocus>
