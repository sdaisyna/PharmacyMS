...
<!-- Address -->
        ...
        <div class="form-group input-group">
         ...
         <div class="form-group input-group">
            ...
            <input id="password" name="password" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" placeholder="Create password" type="password" required autofocus>
        ...
        <div class="form-group input-group">
            ...
            <input id="password-confirm" class="form-control {{ $errors->has('password') ? 'has-error' : '' }}" placeholder="Confirm password" type="password" name="password_confirmation" required>
        </div> 
