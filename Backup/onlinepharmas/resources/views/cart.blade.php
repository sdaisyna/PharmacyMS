        ...
        <table class="table" style="border:1px solid;" id="myTable">
            ...
            @if($addtocart->count()>0)
                @foreach($addtocart as $addtocarts)
                    ...
                    <td> 
                        <input type="number" class="form-control mb-3 col-sm-3 qty" value="1"
            ...
            <div class="border-bottom border-white "></div>
                ...
                <div class="container">
                    ...
                    <div class="mt-3">
                        ...
                        <button class="btn btn-success mb-3 pr-4 pl-4"  data-toggle="modal" data-target="#g" type="submit"> order</button>
