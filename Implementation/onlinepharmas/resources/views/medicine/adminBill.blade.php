...
<div class="billingHead">
    ...
    <div class="row">
    <p class="text-left col-md-6"><label>Bill No.<strong> {{$bill->order_id}}</strong></label>

    </p>

    <p class="text-right col-md-6"> Date:  <label><strong><?php
        echo date('Y-m-d');
        ?></strong></p>
    </div>
    <div class="customer text-left">
    <lable>Customer Name: {{Auth::user()->name}}</label> <br>
...
<div class="Total text-right">
 ...
 <!-- Discount :&nbsp <input  id="dis" type="number" min="0" max="100"> % <br> -->
Grand Total : <b><label  id="gTot"></label></b>
</div>
