...
<div class="form-group">
     ...
     <input class="form-control" name="medicine_name" required autofocus >
</div>
...
<div class="form-group">
     ...
     <input type="form-control" name="rate" class="form-control" required>
</div>
...
<div class="form-group">
     ...
     <input type="form-control" name="qty" class="form-control" required>
</div>
