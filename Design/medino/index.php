            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor">
                        <div class="doctor-img">
                            <img src="assets/images/selfmed2.jpg" alt="" class="img-fluid" >
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="department-slider owl-carousel">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="assets/images/glucose.jpg" alt="" class="img-fluid">
                                <div class="hover-state">
                                    <a href="#l"><i class="fa fa-stethoscope"></i></a>
                                </div>
                            </div>
                            <div class="single-department item-padding text-center">
                                <h3>Dabur Glucose D</h3>
                                <p>Get a jump start on your day by filling up with the extra energy of Dabur Glucose-D
                                  . Enriched with Vitamin-D and Calcium for easy assimilation and quick replenishment
                                   of essential vitamins, minerals and body salts.</p>
                                   <h5><b>Rs.225 for 1kg</b> </h5>
                                <a><button class="btn btn-primary rounded" type="button" name="button" value="Add to Cart">Add to Cart</button></a>
